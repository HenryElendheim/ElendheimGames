...
const GAME = {
  "elendheim-tcg":
    /* HTML */ `<rect x="20" y="26" width="42" height="56" rx="6" fill="#8b5cf6" transform="rotate(-9 41 54)"/>
  ...
  "fruit-slasher":
    /* HTML */ `<circle cx="48" cy="57" r="29" fill="#e23b2e"/>
  ...
  spiderette:
    /* HTML */ `<path d="M50 16C68 38 84 46 84 62a15 15 0 0 1-26 10c1 9 6 13 11 18H31c5-5 10-9 11-18a15 15 0 0 1-26-10C16 46 32 38 50 16Z" fill="#dfe4ee"/>`,
  "kings-corners":
    /* HTML */ `<rect x="38" y="12" width="24" height="34" rx="4" fill="#fafafa"/>
  ...
  solitaire:
    /* HTML */ `<rect x="14" y="24" width="34" height="48" rx="5" fill="#cfd4dd" transform="rotate(-9 31 48)"/>
  ...
  "tile-tap":
    /* HTML */ `<rect x="16" y="10" width="68" height="84" rx="8" fill="#0d0e12"/>
  ...
  wordle:
    /* HTML */ `<rect x="14" y="20" width="20" height="20" rx="3" fill="#6aaa64"/>
  ...
  connect4:
    /* HTML */ `<rect x="8" y="12" width="84" height="76" rx="13" fill="#2b3550"/>
     <circle cx="25" cy="37" r="10" fill="#15161a"/><circle cx="50" cy="37" r="10" fill="#f5a623"/><circle cx="75" cy="37" r="10" fill="#15161a"/>
     <circle cx="25" cy="63" r="10" fill="#e23b2e"/><circle cx="50" cy="63" r="10" fill="#f5a623"/><circle cx="75" cy="63" r="10" fill="#e23b2e"/>`,
  tictactoe:
    /* HTML */ `<g stroke="#cdd3e0" stroke-width="4" stroke-linecap="round">
       <line x1="38" y1="12" x2="38" y2="88"/><line x1="62" y1="12" x2="62" y2="88"/>
       <line x1="12" y1="38" x2="88" y2="38"/><line x1="12" y1="62" x2="88" y2="62"/></g>
     <g stroke="#4fc3f7" stroke-width="4" stroke-linecap="round">
       <line x1="18" y1="18" x2="32" y2="32"/><line x1="32" y1="18" x2="18" y2="32"/>
       <line x1="68" y1="68" x2="82" y2="82"/><line x1="82" y1="68" x2="68" y2="82"/></g>
     <circle cx="50" cy="50" r="7" fill="none" stroke="#f5a623" stroke-width="4"/>`,
  "whack-a-mole":
    /* HTML */ `<ellipse cx="50" cy="76" rx="34" ry="13" fill="#0d0e12"/>
  ...
  blackjack:
    /* HTML */ `<rect x="18" y="34" width="38" height="50" rx="6" fill="#dadada" transform="rotate(-10 37 59)"/>
  ...
  chess:
    /* HTML */ `<text x="30" y="70" font-size="50" fill="#e9edf4" text-anchor="middle" font-family="'Baloo 2', sans-serif">&#9818;</text>
  ...
  tetris:
    /* HTML */ `<g stroke="#15161a" stroke-width="2">
  ...
  "block-blast":
    /* HTML */ `<g stroke="#15161a" stroke-width="2">
       ...
       <rect x="66" y="26" width="18" height="18" rx="3" fill="#18c29c"/></g>`,
};

const UI = {
  trophy:
    /* HTML */ `<path d="M28 18h44v14a22 22 0 0 1-44 0Z" fill="#f5a623"/>
  ...
  plays:
    /* HTML */ `<rect x="14" y="34" width="72" height="36" rx="18" fill="none" stroke="currentColor" stroke-width="7"/>
  ...
  chart:
    /* HTML */ `<rect x="18" y="50" width="15" height="30" rx="2" fill="currentColor"/>
     <rect x="42" y="32" width="15" height="48" rx="2" fill="currentColor"/>
     <rect x="66" y="42" width="15" height="38" rx="2" fill="currentColor"/>`,
  fullscreen:
    /* HTML */ `<g fill="none" stroke="currentColor" stroke-width="7" stroke-linecap="round" stroke-linejoin="round">
  ...
  spider:
    /* HTML */ `<g fill="none" stroke="#241046" stroke-width="5" stroke-linecap="round">
  ...
  gear:    
    /* HTML */ `<g fill="none" stroke="currentColor" stroke-width="8" stroke-linecap="round">
